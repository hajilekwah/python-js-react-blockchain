...
class Block:
    ...
    def genesis():
        ...
        ## double asterisks references the dictionary, then passes each k-v pairing as an argument to Block

    @staticmethod
    def from_json(block_json):
        """
        Deserialize a block's json represenation back into a block instance.
        """
    ...
    def adjust_difficulty(last_block, new_timestamp):
        ...
        Increase the difficulty for the quickly mined blocks.
